...
async function connect(agentContext = null) {
    ...
    if (
        ...
        logger().info?.(
            'Minecraft client allaqachon ulanish jarayonida yoki ulangan.'
        );
...
async function initialize(
    ...
    /*
     MUHIM:
     Bu yerda connect() CHAQRILMAYDI.
     Ulanishni index.js faqat bir marta boshlaydi.
    */
}
