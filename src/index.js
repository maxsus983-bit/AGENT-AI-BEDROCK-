...
async function start() {
    ...
    /*
    MUHIM:
    Minecraft initialize() funksiyasi client.js ichida
    ulanishni o'zi boshlaydi.

    Shu sababli bu yerda yana connect() chaqirilmaydi.
    Bu ikki marta ulanish muammosini bartaraf qiladi.
    */
